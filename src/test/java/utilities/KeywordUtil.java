...
public class KeywordUtil extends GlobalUtil {
	...
	public static void onExecutionFinish() {
		...
		if (extentReport.exists()) {
			...
			try {
				Runtime.getRuntime().exec(
						"C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe \"" + htmlExtentReportFile + "\"");
	...
	public static boolean click(By locator, String logStep) {
		...
		if (elm == null) {
			...
			elm.click();
			RunCukesTest.logger.log(LogStatus.PASS, HTMLReportUtil.passStringGreenColor(stepName));
			return true;
		}
	}
	...
	public static boolean inputTextToWebElement(By locator, String data,String logStep) {
	...
	public static boolean switchToFrameByID(int frameID) {
		...
		try {
			...
			LogUtil.infoLog("switchToFrame", frameID + " TO FRAME FAILED" + e.getStackTrace());
			return false;
		}
	}
	...
	public static int countOfFrames() {
	...
	public static boolean inputAfterText(By locator, String data,String logStep) {
		stepName=logStep;
		KeywordUtil.lastAction = "Input Text: " + data + " - " + locator.toString();
		LogUtil.infoLog(KeywordUtil.class, KeywordUtil.lastAction);
		WebElement elm = waitForVisible(locator);
